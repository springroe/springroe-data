...
public class JpaUtils {
     ...
     * @return
     */
    public final <T extends Persistable<?>> T buildEntity(Class<T> entityClass, Tuple tuple, List<? extends Selection<?>> selections, List<? extends Selection<?>> baseSelections, Map<Join<?, ?>, ? extends List<? extends Path<?>>> toOneJoinMap, List<OneToManyAttributeData> oneToManyDataList) {
        return null;
    }
